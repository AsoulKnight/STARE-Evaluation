...
from models.transunet_model import TransUNet
from utils.metrics import dice_score, dice_loss, iou_score, format_time, FocalLoss
...
PRETRAIN_PATH = "C:/1.lwBrown/Lee Lab/Evaluation_STARE/models/R50+ViT-B_16.npz"
...
EXPERIMENT_NAME = "transunet_train_pos5_lr1e-5_epoch500_wd1e-5_bs1_doubledice_5e-6at30epochs"
RESUME = True

BASE_SAVE_DIR = "C:/1.lwBrown/Lee Lab/Evaluation_STARE/experiments_transunet"
BASE_MODEL_DIR = os.path.join(BASE_SAVE_DIR, "transunet_base_train")
# change to "inference" or "train"

MODE = "train"
##### change the path file name here to continue training ####
# MODEL_PATH = os.path.join(BASE_MODEL_DIR, "model.pth")
MODEL_PATH = os.path.join(BASE_MODEL_DIR, "checkpoint_epoch300.pth")
...
def train_one_epoch(model, loader, optimizer):
    ...
    for images, masks in loader:
        ...
        loss = bce_loss(outputs, masks) + focal_loss(outputs, masks)
...
def train_single_split():
    ...
    print("Transformer frozen (training decoder only)")
    #####################################
